...
\verb+acopost-complementary-rate [-h] ref a b+
...
\verb+acopost-cooked2lex [-h] [-c] < in.cooked > out.lex+
...
\verb+acopost-cooked2ngram [-h] < in.cooked > out.ngram+
...
\verb+acopost-cooked2tt [-h] < in.cooked > out.tt+
...
\verb+acopost-cooked2wsj [-h] < in.cooked > out.wsj+
...
\verb+acopost-cooked2wtree OPTIONS f-file < in.cooked > out.wsj+
...
\verb+acopost-et OPTIONS knownwtree unknownwtree lexiconfile [in.raw] > out.cooked+
...
...
PROMPT> acopost-cooked2wtree -b 2 unknown.etf -e closed-class-tags < train.cooked > unknown.wtree
...
PROMPT> acopost-et known.wtree unknown.wtree train.lex < test.raw > test.et
[        0 ms::1]
...
\verb+acopost-evaluate+ [-h] [[-i] -l l] [-v] ref t1 ...
...
\verb+acopost-majority-voter+ [-h] ref t1 t2 ...
...
\begin{small}
\begin{verbatim}
PROMPT> acopost-met -c test -d train.lex train.model.met < test.cooked
...
\verb+acopost-t3 OPTIONS modelfile lexiconfile [in.raw] > out.cooked+
...
...
PROMPT> acopost-t3 train.ngram train.lex < test.raw > test.t3
[        0 ms::1]
...
\verb+acopost-tt2cooked [-h] < in.tt > out.cooked+
