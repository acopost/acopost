...
\verb+wsj2cooked+ (cf.\ Section~\ref{S:wsj2cooked}),
\verb+tt2cooked+ (cf.\ Section~\ref{S:tt2cooked}) and
\verb+cooked2tt+ (cf.\ Section~\ref{S:cooked2tt}).
...
\verb+complementary-rate [-h] ref a b+
...
\begin{verbatim}
PROMPT> ~/acopost/bin/complementary-rate 0.ref 0.t3 0.tnt
...
\verb+cooked2lex [-h] [-c] < in.cooked > out.lex+
...
\begin{verbatim}
PROMPT> cooked2lex < negra.cooked > negra.lex
20602 sentences
...
\verb+cooked2ngram [-h] < in.cooked > out.ngram+
...
\begin{verbatim}
PROMPT> cooked2ngram < corpus.cooked > corpus.ngram
\end{verbatim}

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
\subsection{cooked2tt}
\label{S:cooked2tt}
...
\verb+cooked2tt [-h] < in.cooked > out.tt+
...
\begin{verbatim}
PROMPT> cooked2tt < negra.cooked > negra.tt
20602 sentences
PROMPT>
\end{verbatim}
...
\verb+cooked2wsj [-h] < in.cooked > out.wsj+
...
\verb+cooked2wtree OPTIONS f-file < in.cooked > out.wsj+
...
\begin{small}
\begin{verbatim}
PROMPT> cooked2lex < train.cooked > train.lex
...
PROMPT> cooked2wtree -a 3 known.etf < train.cooked > known.wtree
...
PROMPT> cooked2wtree -b 2 unknown.etf -e closed-class-tags < train.cooked > unknown.wtree
...
...
[     3590 ms::1] done
PROMPT> evaluate test.cooked test.et
2060 sentences
...
\verb+evaluate+ [-h] [[-i] -l l] [-v] ref t1 ...
...
\begin{verbatim}
PROMPT> evaluate 0.ref 0.t3 0.tnt
1002 sentences
...
\verb+majority-voter+ [-h] ref t1 t2 ...
...
\begin{verbatim}
PROMPT> majority-voter 0.ref 0.t3 0.tbt 0.et 0.met
2061 sentences
35674 words
...
PROMPT> cooked2lex < train.cooked > train.lex
...
PROMPT> cooked2ngram < train.cooked > train.ngram
...
...
[    21690 ms::1] done
PROMPT> evaluate test.cooked test.t3
2061 sentences
...
PROMPT> evaluate test.cooked test.tbt
2061 sentences
...
\verb+tt2cooked [-h] < in.tt > out.cooked+
...
\begin{verbatim}
PROMPT> tt2cooked < negra.tt > negra.cooked
396309 lines read
PROMPT>
\end{verbatim}

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
\subsection{wsj2cooked}
\label{S:wsj2cooked}
...
\verb+wsj2cooked < in.wsj > out.cooked+

\subsubsection{Example}

\begin{verbatim}
PROMPT> wsj2cooked < corpus.wsj > negra.cooked
PROMPT>
\end{verbatim}
